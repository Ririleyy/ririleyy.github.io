  ...
  const pages = {
    'index.html': {
      ...
      text: {
        ...
        '.visual-caption strong': '构建下一个世界',
        '.visual-caption small': '虚幻引擎 / 开发中',
        ...
        '.games-played > p:not(.games-label)': '我喜欢温馨的世界、奇异的解谜叙事、物理驱动的喜剧效果，以及充满混乱乐趣的合作体验。',
      ...
      html: {
        ...
        '#hero-title': '我创造<br>真正<em>鲜活</em>的世界。',
      ...
      attrs: {
        ...
        '.hero-visual': { 'aria-label': '代表 Jiayi 正在开发中的游戏的暗黑幻想城堡场景' },
        '.hero-visual > img': { 'alt': '月夜哥特拱廊外的幻想城堡' },
    ...
    'fishing-engine.html': {
      title: '钓鱼游戏与自研引擎 — Jiayi Li 项目',
      description: 'Jiayi Li 使用自研 C++/OpenGL 渲染引擎开发的风格化钓鱼游戏。',
      text: {
        '.project-resume': '简历 ↓',
        ...
        '.project-meta li:nth-child(2) span': '技术栈',
        '.project-meta li:nth-child(3) span': '类型',
        '.project-meta li:nth-child(3) strong': '钓鱼游戏',
        '.project-meta li:nth-child(4) span': '重点',
        ...
        '.overview-copy p:nth-child(1)': '这款钓鱼游戏是一个构建在专注型自研 C++/OpenGL 引擎上的完整交互项目。',
        ...
        '.system-card:nth-child(6) h3': '钓鱼玩法',
      ...
      attrs: {
        '.project-meta': { 'aria-label': '项目详情' },
        '.demo-frame video': { 'aria-label': '钓鱼游戏与自研引擎完整演示' }
      }
    },
    'graphics.html': {
